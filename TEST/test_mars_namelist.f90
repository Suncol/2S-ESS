...
!  START CODE $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
   ...
   write(*,*)
   write(*,*) 'Doing 2S-ESS calculation with Mars namelist configuration'
   write(*,*)

!  Load Earth configuration from namelist
   write(*,*) 'Loading Mars configuration from namelist...'
...
write(*,*) 'MARS NAMELIST CONFIGURATION TEST RESULTS'
...
write(*,*) 'Planet radius used = ', planet_cfg%radius_km, ' km'
   ...
   open(1, file = 'test_mars_namelist_output.dat')   
   ...
   open(2, file = 'test_mars_namelist_timings.dat')     
...
69 continue
   ...
   write(*,*) 'Error in running Mars namelist test'

!  End program

end program test_mars_namelist