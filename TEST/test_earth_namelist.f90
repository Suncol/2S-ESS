...
!  START CODE $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
   ...
   write(*,*)
   write(*,*) 'Doing 2S-ESS calculation with Earth namelist configuration'
   write(*,*)
...
write(*,*) 'EARTH NAMELIST CONFIGURATION TEST RESULTS'
...
write(*,*) 'Planet radius used = ', planet_cfg%radius_km, ' km'

   ! output data into a file 
   open(1, file = 'test_earth_namelist_output.dat')   
   ...
   open(2, file = 'test_earth_namelist_timings.dat')     
      ...
      write(2,*) '2S geom calc time = ', geom_timer
...
69 continue
   ...
   write(*,*) 'Error in running Earth namelist test'

!  End program

end program test_earth_namelist